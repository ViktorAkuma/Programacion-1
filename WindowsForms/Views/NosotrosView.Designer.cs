namespace WindowsForms.Views
{
    partial class NosotrosView
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 10F));
            tableLayoutPanel.Size = new Size(481, 390);
            ...
            logoPictureBox.Size = new Size(150, 380);
            ...
            labelProductName.Size = new Size(311, 26);
            labelProductName.TabIndex = 19;
            labelProductName.Text = "App Clima";
            labelProductName.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // labelVersion
            // 
            labelVersion.Dock = DockStyle.Fill;
            labelVersion.Location = new Point(166, 39);
            labelVersion.Margin = new Padding(8, 0, 4, 0);
            labelVersion.MaximumSize = new Size(0, 26);
            labelVersion.Name = "labelVersion";
            labelVersion.Size = new Size(311, 26);
            ...
            labelCompanyName.Location = new Point(166, 117);
            labelCompanyName.Margin = new Padding(8, 0, 4, 0);
            labelCompanyName.MaximumSize = new Size(0, 26);
            labelCompanyName.Name = "labelCompanyName";
            labelCompanyName.Size = new Size(311, 26);
            labelCompanyName.TabIndex = 22;
            labelCompanyName.Text = "Instituto Superior del Profesorado N°20";
            labelCompanyName.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // textBoxDescription
            // 
            textBoxDescription.Dock = DockStyle.Fill;
            textBoxDescription.Location = new Point(166, 161);
            textBoxDescription.Margin = new Padding(8, 5, 4, 5);
            textBoxDescription.Multiline = true;
            textBoxDescription.Name = "textBoxDescription";
            textBoxDescription.ReadOnly = true;
            textBoxDescription.ScrollBars = ScrollBars.Both;
            textBoxDescription.Size = new Size(311, 185);
            textBoxDescription.TabIndex = 23;
            textBoxDescription.TabStop = false;
            textBoxDescription.Text = "Proyecto realizado en la catedra de Programación de 2do año de la carrera Técnico Superior en Desarrollo de Software.";
            ...
            okButton.Location = new Point(377, 356);
            okButton.Margin = new Padding(4, 5, 4, 5);
            okButton.Name = "okButton";
            okButton.Size = new Size(100, 29);
